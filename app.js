...
client.on('ready', () => {
    ...
    var sun = new CronJob(
        ...
        function(){
            ...
            client.channels.cache.get("752334786260893697").send(`Hi @everyone! We are now accepting applications for the 2022 - 2023 WHS Comp Sci Club Officer Team! (no exp needed) \nApplications can be found here: <https://forms.gle/jbJjGfiZdCL3eXp69>`);
        },
        null,
        true,
        'America/Los_Angeles'
